...
public enum TicketStage {
    ...
    WORK_DONE("Готово", "Готов к выдаче", true),
    CLIENT_NOTIFIED("Клиент оповещён", "Клиент оповещён о готовности", true),
    DELIVERED("Выдано", "Аппарат выдан или квитанция закрыта", true),
    DOCUMENTED("Обработано", "Обработано", true),
    WAITING_FOR_PAYMENT("Ждем оплату", "Ждем оплату от клиента", true);

    TicketStage(final String title,
